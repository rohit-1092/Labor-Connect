...
const Join = () => {
  ...
  const handleJoin = (e) => {
    ...
    axios.post(`${apiURL}/${checkEmailURL}`, {
      user: { email }
    }, {
      headers: {
  ...
  return (
    <div className="popup-container text-[#333333] flex flex-col items-center justify-center gap-10 bg-white px-16 py-10 w-[35vw] rounded-xl border-4 border-[#EB5757] hover:border-[#EB7357] relative">
      <i
